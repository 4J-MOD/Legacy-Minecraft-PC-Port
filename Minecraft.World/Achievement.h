...
public:
	Achievement(int id, const wstring& name, int x, int y, Item *icon, Achievement *req);
    Achievement(int id, const wstring& name, int x, int y, Tile *icon, Achievement *req);
    Achievement(int id, const wstring& name, int x, int y, shared_ptr<ItemInstance> icon, Achievement *req);
